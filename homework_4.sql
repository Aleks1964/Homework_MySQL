...
-- Последнее задание, таблица: https://drive.google.com/file/d/1TZzW8ZlDdvIfDC9C46bUeILey6opQjdu/view?usp=share_link
...
SELECT * FROM shops
WHERE id = (SELECT shops_id FROM cats WHERE name = "Murzik"); -- с подзапросом
...
WHERE ord_datetime BETWEEN '2020-02-05 00:00:00' AND ('2020-02-05  00:00:00' + INTERVAL 1 WEEK);